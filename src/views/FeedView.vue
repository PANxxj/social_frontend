    ...
    <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
        <!-- <div class="mai-left col-span-1">
            <div class="p-4 bg-white border border-gray-200 text-center rounded-lg">
                ...
                <p><strong>Social Baba</strong></p>
                <div class="mt-6 flex space-x-8 justify-around">
                    <p class="text-ts text-gray-500">183 friends</p>
                    <p class="text-ts text-gray-500">120 posts</p>
                </div>
            </div>
        </div> -->
        ...
        <div class="main-center col-span-3 space-y-4">
            ...
            <!-- <div class="p-4 bg-white border border-gray-200 rounded-lg">
                <div class="mb-6 flex items-center justify-between">
                    ...
                    <p class="text-gray-600">19 minutes ago</p>
                </div>

                <img src="https://images.unsplash.com/photo-1682687982502-1529b3b33f85?ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"
